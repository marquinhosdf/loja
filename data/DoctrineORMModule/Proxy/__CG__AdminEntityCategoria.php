...
class Categoria extends \Admin\Entity\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nome', 'slug', 'categoria', 'children', 'status');
        }
     ...
     * {@inheritDoc}
     */
    public function setCategoria(\Admin\Entity\Categoria $categoria)
    {
     ...
     * {@inheritDoc}
     */
    public function setChildren(\Admin\Entity\Categoria $children)
    {
