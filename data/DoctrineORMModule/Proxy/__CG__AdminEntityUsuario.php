...
class Usuario extends \Admin\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nome', 'email', 'senha', 'token', 'status', 'dtaInc', 'perfil');
        }
     ...
     * {@inheritDoc}
     */
    public function setPerfil(\Admin\Entity\Perfil $perfil)
    {
    ...
    public function criptSenha($senha)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'criptSenha', array($senha));

        return parent::criptSenha($senha);
    }
